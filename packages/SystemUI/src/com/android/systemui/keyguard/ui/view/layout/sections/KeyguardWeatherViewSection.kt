    ...
    override fun applyConstraints(constraintSet: ConstraintSet) {
        ...
        constraintSet.apply {
            ...
            if (!isLargeClock) {
                ...
                connect(R.id.weather_inline_text, ConstraintSet.START, ClockViewIds.LOCKSCREEN_CLOCK_VIEW_SMALL, ConstraintSet.END, 0)
            ...
            weatherView?.setPaddingRelative(0, 0, 0, 0)
