...
fun BatteryLayout(
    ...
    Layout(
        content = {
            ...
            if (iconStyle == BatteryRepository.ICON_STYLE_CIRCLE ||
...
class BatteryMeasurePolicy : MeasurePolicy {
    ...
    override fun MeasureScope.measure(
        ...
        val batteryFrame = measurables.fastFirstOrNull {
    ...
    Canvas(modifier = modifier, contentDescription = contentDescription) {
        ...
        if (level != null && level > 0) {
            drawArc(
                ...
                style = Stroke(
                    strokeWidth,
                    pathEffect = if (iconStyle == BatteryRepository.ICON_STYLE_CIRCLE_DOTTED) {
