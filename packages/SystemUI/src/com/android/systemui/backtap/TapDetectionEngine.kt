...
class TapDetectionEngine(
    ...
    private fun processResampledSample(s: Resampler.Sample) {
        ...
        val threshold = (noiseFloor * sensitivityMultiplier).coerceIn(0.001f, 0.25f)
    ...
    private fun recognizeTap(tNs: Long) {
        ...
        if (newerPeakId - olderPeakId !in 1..7) return 
        ...
        val maxAmp = maxOf(positivePeakDetector.amplitude, negativePeakDetector.amplitude)
        onTapDetected(maxAmp)
    }
