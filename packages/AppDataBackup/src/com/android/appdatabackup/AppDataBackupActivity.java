...
public class AppDataBackupActivity extends Activity {
    ...
    /** Paints a colorful, rounded "squircle" avatar tile from the app's initial. */
    private void bindAvatar(FrameLayout box, TextView initial, String label, String key) {
    ...
    private final class AppListAdapter
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            bindAvatar(holder.avatarBox, holder.avatar, info.getLabel(), info.getPackageName());
    ...
    private final class BackupListAdapter
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            bindAvatar(holder.avatarBox, holder.avatar, record.getLabel(), record.getPackageName());
