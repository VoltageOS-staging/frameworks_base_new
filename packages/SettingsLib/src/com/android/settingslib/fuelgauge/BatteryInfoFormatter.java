...
public final class BatteryInfoFormatter {
    ...
    /**
     * Discharge rate derived from the coulomb counter (mAh) instead of the coarse
     * integer discharge-percent. This reads non-zero within seconds of use, where
     * {@link #formatDischargeRate(int, long)} stays at 0 until a whole percent drains.
     *
     * @param dischargeMah mAh consumed over the period (fine-grained, from uAh stats)
     * @param periodMs     length of the period in milliseconds
     * @param capacityMah  battery capacity in mAh (learned, else estimated)
     */
