...
/**
 * Represents a single completed backup snapshot for one package.
 *
 * A BackupRecord corresponds to a directory on storage:
 * <pre>
 *   {@code <backupDir>/<id>/
 *       manifest.json       - metadata + checksums
 *       base.apk            - copied base APK
 *       split_*.apk         - copied split APKs (if any)
 *       data_ce.tar         - CE app-data snapshot archive
 *       data_de.tar         - DE app-data snapshot archive (if present)
 *   }
 * </pre>
 *
 * @hide
