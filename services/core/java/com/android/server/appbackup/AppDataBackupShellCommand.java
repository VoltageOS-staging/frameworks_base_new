...
/**
 * Handles {@code adb shell cmd app_data_backup <subcommand>} commands.
 *
 * <pre>
 * Usage:
 *   cmd app_data_backup list   --dir &lt;path&gt; [--user &lt;userId&gt;]
 *   cmd app_data_backup backup --package &lt;pkg&gt; [,&lt;pkg&gt;...] --dir &lt;path&gt;
 *                              [--exclude-cache] [--user &lt;userId&gt;]
 *   cmd app_data_backup restore --id &lt;backupId&gt; [,&lt;id&gt;...] --dir &lt;path&gt;
 *                               [--user &lt;userId&gt;]
 *   cmd app_data_backup delete  --id &lt;backupId&gt; --dir &lt;path&gt;
 *   cmd app_data_backup apps    [--user &lt;userId&gt;]
 * </pre>
 *
 * @hide
 */
