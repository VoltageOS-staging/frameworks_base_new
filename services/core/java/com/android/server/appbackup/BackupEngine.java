...
public class BackupEngine {
    ...
    public BackupRecord backupPackage(@NonNull PackageInfo packageInfo,
        ...
        final File finalFile = new File(backupDir, backupId + BackupArchive.EXTENSION);
        ...
        try {
            ...
            // Capture per-app state that does not live in the CE/DE/external
            // data dirs: runtime permissions, app-ops / special access, SSAID.
            // These are written as sidecar JSON files alongside the data tars
            // and are therefore covered by the directory checksum below.
            ...
            BackupArchive.write(finalFile, manifest.toJson(), entryFiles, passphrase);
            deleteRecursive(tmpDir);
