...
public class RestoreEngine {
    ...
    public BackupResult restorePackage(@NonNull BackupRecord record, int userId,
        ...
        // Unpack (and decrypt, if needed) the single-file archive into a private
        // staging directory next to it, then run the restore against that dir.
        final File extractDir = new File(record.getBackupDir(),
                "." + record.getId() + ".restore");
