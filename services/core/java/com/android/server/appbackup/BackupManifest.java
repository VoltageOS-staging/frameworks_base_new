...
/**
 * Reads and writes the {@code manifest.json} file that describes a single backup record.
 *
 * <p>The JSON structure is:
 * <pre>
 * {
 *   "id":          "com.whatsapp_1700000000000",
 *   "packageName": "com.whatsapp",
 *   "label":       "WhatsApp",
 *   "versionName": "2.24.1.79",
 *   "versionCode": 1234567890,
 *   "timestampMs": 1700000000000,
 *   "apkSize":     60000000,
 *   "ceDataSize":  200000000,
 *   "deDataSize":  512000,
 *   "encrypted":   false,
 *   "state":       0,
...
class BackupManifest {
    ...
    BackupManifest(String id, String packageName, String label, String versionName,
            ...
            long deDataSize, boolean encrypted, int state, String checksum, int userId) {
        mId = id;
